...
class EmberEndpoint(EzspStruct):
    ...
    _fields = [
        ...
        ('profileId', basic.uint16_t),
        ('deviceId', basic.uint16_t),
        ('appFlags',  basic.uint8_t),
        ('inputClusterCount', basic.uint8_t),
        ('outputClusterCount', basic.uint8_t),
        ('inputClusterList', basic.List(basic.uint16_t)),
        ('outputClusterList', basic.List(basic.uint16_t)),
    ]
